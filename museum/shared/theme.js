...
const VIEWER_PALETTES = Object.freeze({
  ...
  [DARK_THEME]: Object.freeze({
    ...
    floor: 0x242a37,
    pedestal: 0x313848,
    sculptureColor: "#f2ebe6",
    sculptureSheen: "#fff7f2"
  })
});
...
const TOUR_PALETTES = Object.freeze({
  ...
  [DARK_THEME]: Object.freeze({
    ...
    entry: 0xefbfa5,
    pedestal: 0x353d4d,
    sculptureColor: "#f3ece7",
    sculptureSheen: "#fff8f3",
    labelFill: "rgba(20, 24, 36, 0.92)",
    labelStroke: "rgba(125, 136, 168, 0.74)",
    labelKicker: "#deae9d",
    labelTitle: "#f6f0ec",
    labelMeta: "#bec4d3",
    exposure: 0.5
...
export function getStoredTheme() {
  return normalizeTheme(safeStorageGet(THEME_STORAGE_KEY) || DARK_THEME);
}
