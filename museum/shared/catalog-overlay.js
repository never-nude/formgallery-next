...
const SAN_ILDEFONSO_SOURCE = smkSource({
  summary: "Rendered from SMK Open's plaster-cast scan of the San Ildefonso Group, localized into Form Gallery's native STL viewer.",
  ...
  note: "SMK catalogs the mesh itself as a plaster cast. The original marble group is in the Museo del Prado, where it is commonly identified as Orestes and Pylades or The San Ildefonso Group and displayed in Room 071."
});
const SAN_ILDEFONSO_DEFAULTS = Object.freeze({
  zoom: 3.12,
  lightAngle: 26,
  lightPower: 2.14,
  exposure: 0.3,
...
const SAN_ILDEFONSO_MODEL = Object.freeze({
  primaryUrl: "/castor-and-pollux/castor_and_pollux_source_small.stl",
  fallbackUrl: "/castor-and-pollux/castor_and_pollux_source_small.stl"
});
const SAN_ILDEFONSO_BASE = Object.freeze({
  kind: "stl",
  sectionId: "roman-world",
  sortOrder: 28.55,
  subtitle: "Artist: Unknown Roman workshop",
  medium: "White Carrara marble group",
  dimensions: "H: 161 cm | W: 106 cm | D: 56 cm",
  location: "Room 071, Museo del Prado",
  locationLabel: "On view:",
  lobbyMeta: "Source: SMK Open plaster-cast scan (KAS2362); original at the Prado",
  source: SAN_ILDEFONSO_SOURCE,
  defaults: SAN_ILDEFONSO_DEFAULTS,
  model: SAN_ILDEFONSO_MODEL
});
...
export const museumPiecesExtension = {
  ...
  "orestes-and-pylades": {
    ...SAN_ILDEFONSO_BASE,
    path: "/orestes-and-pylades/",
    viewerTitle: "Orestes and Pylades or The San Ildefonso Group (Roman group, 1st century BCE)"
  },
  "castor-and-pollux": {
    ...SAN_ILDEFONSO_BASE,
    path: "/castor-and-pollux/",
    hiddenFromLobby: true,
    viewerTitle: "Castor and Pollux / Orestes and Pylades (The San Ildefonso Group, Roman group, 1st century BCE)"
  },
